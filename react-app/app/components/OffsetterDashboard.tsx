      ...
      <div className="h-screen w-full flex overflow-hidden select-none">
            ...
            <>
              ...
              <div className="flex">
                ...
                >
                  ...
                  >
                    <span>Upcoming funding opportunities</span>
                      ...
                      <li className="mt-2">
                        ...
                        >
                          ...
                          >
                            ...
                            tempore delectus consectetur ullam reprehenderit
                            quis ducimus, iusto dolor nam corporis id
                            perspiciatis consequuntur saepe excepturi.
                          </p>
        ...
        >
          ...
          <span className="mt-1 text-3xl font-semibold">
            {(Number(balance?.value) / 10 ** 18).toFixed(4)} ETH
          </span>
