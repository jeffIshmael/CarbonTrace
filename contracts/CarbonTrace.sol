...
contract CarbonTrace is ERC20{
    ...
    constructor() ERC20("CarbonTrace", "CBT") {
    ...
    //function to buy CBT tokens
    function getCBT(uint _amount) public payable{
        require(msg.value == _amount/100000, "Thats not right amount");
        (bool sent,) = address(this).call{value: msg.value}("");
        require(sent,"Ensure you have enough ethers");
    ...
    function approveOffsetProposal( uint _proposalId) public payable {
        ...
        require(sent,"Failed to process payout");
